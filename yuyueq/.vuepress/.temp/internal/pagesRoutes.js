...
const routeItems = [
  ...
  ["v-8daa1a0e","/",{"title":"Yuyueq","icon":"home","type":"home","readingTime":{"minutes":0.23,"words":68},"excerpt":"这是普通主页的案例。你可以在这里放置你的主体内容。 想要使用此布局，你需要在页面 front matter 中设置 home: true。 配置项的相关说明详见 项目主页配置。"},["/index.html","/README.md"]],
