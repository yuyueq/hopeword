...
import { useAutoLink, useIconPrefix, useNavigate, useThemeLocaleData, } from "@theme-hope/composables";
                ...
                prevNavLink.value
                    ? h(AutoLink, { class: "prev", config: prevNavLink.value }, () => {
                        ...
                        return [
                            ...
                            h("div", { class: "link" }, [
                                ((_a = prevNavLink.value) === null || _a === void 0 ? void 0 : _a.icon)
                                    ? h("i", {
                    ...
                    ? h(AutoLink, { class: "next", config: nextNavLink.value }, () => {
                        ...
                        return [
                            ...
                            h("div", { class: "link" }, [
                                ...
                                ((_b = nextNavLink.value) === null || _b === void 0 ? void 0 : _b.icon)
                                    ? h("i", {
