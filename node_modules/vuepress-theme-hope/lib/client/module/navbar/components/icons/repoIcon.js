...
import { h } from "vue";
export const GitHubIcon = () => h(IconBase, { name: "github" }, () => h("path", {
...
export const GitlabIcon = () => h(IconBase, { name: "gitlab" }, () => h("path", {
...
export const GiteeIcon = () => h(IconBase, { name: "gitee" }, () => h("path", {
...
export const BitbucketIcon = () => h(IconBase, { name: "bitbucket" }, () => h("path", {
...
export const SourceIcon = () => h(IconBase, { name: "source" }, () => h("path", {
