import { capitalize, generateIndexfromHash, } from "@mr-hope/vuepress-shared/lib/client";
...
export default defineComponent({
    ...
    setup() {
        ...
        return () => h("ul", { class: "category-list-wrapper" }, Object.keys(categoryMap.value.map).map((category) => {
