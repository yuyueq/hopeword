...
declare type ModifyTimeGetter = <ExtraPageData = {
    git: GitData;
}>(page: Page<ExtraPageData>) => string;
...
declare const sitemap: (options: SitemapOptions | false) => PluginConfig<SitemapOptions>;

export { ModifyTimeGetter, SitemapFrontmatterOption, SitemapImageOption, SitemapLinkOption, SitemapNewsOption, SitemapOptions, SitemapVideoOption, sitemapPlugin as default, sitemap, sitemapPlugin };
